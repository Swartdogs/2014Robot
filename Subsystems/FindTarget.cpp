...
//		CommandBase::ballShooter->LogPosition("Start Image");
//	}
//
//	if(m_findStep == iGetImage) {
//		CommandBase::ballShooter->LogPosition("Get Image");
//		cameraImage = m_camera->GetImage();
//		cameraImage->Write("HotTarget.jpg");
////		printf("GetImage Time=%f\n", GetClock() * 1000 - startTime);
//		m_findStep = iFilterImage;
//
//	} else if(m_findStep == iFilterImage) {
//		CommandBase::ballShooter->LogPosition("Color Filter");
////		filterImage = cameraImage->ThresholdHSL(10, 120, 70, 255, 70, 255);
////		filterImage = cameraImage->ThresholdHSL(60, 120, 70, 255, 50, 185);		// CF Settings
////		filterImage = cameraImage->ThresholdHSL(60, 120, 12, 255, 50, 200);		// Tested in Pekin
//		filterImage = cameraImage->ThresholdHSL(38, 138, 90, 255, 65, 255);		// Experimental Queen City Values
////		printf("Color Threshold Time=%f\n", GetClock() * 1000 - startTime);
//
//		m_findStep = iParticleFilter;
//
//	} else if(m_findStep == iParticleFilter) {
//		CommandBase::ballShooter->LogPosition("Particle Filter");
//		ParticleFilterCriteria2  filterCriteria[] = {
//				{IMAQ_MT_AREA, 150, 65535, false, false}
//		};
//		filterImage = filterImage->ConvexHull(true);
...
//		CommandBase::ballShooter->LogPosition("Analyze Image");
